...
func NewRouter(cfg *config.ConfigServer, repo repository.GophProfileRepository, auditNotifier *audit.Notifier, minioClient *minio.Client) *gin.Engine {
	router := gin.Default()
	...
	setupRoutes(router, cfg, repo, auditNotifier, minioClient)
